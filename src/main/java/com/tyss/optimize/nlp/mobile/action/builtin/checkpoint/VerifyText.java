...
import com.tyss.optimize.nlp.mobile.action.natives.GetText;
...
@Slf4j
@Component(value = "MOB_VerifyText")
public class VerifyText implements Nlp {
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("}\n");
        sb.append("if (match) {\n");
        sb.append("	System.out.println(\"The text is \" + expectedText);\n");
        sb.append("} else {\n");
        sb.append("	System.out.println(\"The text is not \" + expectedText);\n");
        sb.append("}\n");
