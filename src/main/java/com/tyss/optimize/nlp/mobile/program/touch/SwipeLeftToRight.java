...
@Slf4j
@Component(value = "MOB_SwipeLeftToRight")
public class SwipeLeftToRight implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            if (fromX < toX) {
                ...
                log.info("Swiped from left to right");
                nlpResponseModel.setMessage(passMessage);
                nlpResponseModel.setStatus(CommonConstants.pass);
            } else {
                log.info("Entered coordinate value is wrong");
                log.error("Failed to swipe from left to right\n");
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("	 System.out.println(\"Swiped from left to right\");\n");
        sb.append("} else {\n");
        sb.append("	 System.out.println(\"Entered coordinate value is wrong\");\n");
        sb.append("	 System.out.println(\"Failed to swipe from left to right\");\n");
        sb.append("}\n");
