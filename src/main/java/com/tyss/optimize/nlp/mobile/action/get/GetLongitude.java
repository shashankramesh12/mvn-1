...
@Slf4j
@Component(value = "MOB_GetLongitude")
public class GetLongitude implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            deviceLocation = ((Location) ((NlpResponseModel) new GetDeviceLocation().execute(requestDevice)).getAttributes().get("location")).getLongitude();
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("Double deviceLocation = androidDriver.location().getLongitude();\n");
