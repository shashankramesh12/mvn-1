...
@Slf4j
@Component(value = "MOB_GetLatitude")
public class GetLatitude implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            deviceLocation = ((Location) ((NlpResponseModel) new GetDeviceLocation().execute(requestDevice)).getAttributes().get("location")).getLatitude();
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("Double deviceLocation = androidDriver.location().getLatitude();\n");
