package com.tyss.optimize.nlp.mobile.program.checkpoint;
...
@Slf4j
@Component(value = "MOB_ComparePartialStringValue")
public class ComparePartialStringValue implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Verifying if " + actualString + " contains " + expectedString);
            Boolean match = false;
            if (caseSensitive) {
