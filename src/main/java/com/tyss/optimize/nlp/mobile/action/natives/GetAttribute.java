...
@Slf4j
@Component(value = "MOB_GetAttribute")
public class GetAttribute implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Getting attribute " + attributeName + " value of from the element: " + elementName + " " + elementType);

            value = element.getAttribute(attributeName);
            log.info("Successfully fetched attribute " + attributeName + " value of " + elementName + " " + elementType);
