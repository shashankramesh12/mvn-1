...
public class GetY implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            yLocation = ((Point) ((NlpResponseModel) new GetLocation().execute(requestLocation)).getAttributes().get("location")).getY();
            log.info("Successfully fetched y coordinate of " + elementName + " " + elementType);
            nlpResponseModel.setMessage(modifiedPassMessage.replace("*returnValue*", yLocation.toString()));
