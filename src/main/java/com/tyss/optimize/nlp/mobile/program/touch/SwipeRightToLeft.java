...
@Slf4j
@Component(value = "MOB_SwipeRightToLeft")
public class SwipeRightToLeft implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            if (fromX > toX) {
                ...
                log.info("Swiped the screen from  right to left");
                nlpResponseModel.setMessage(passMessage);
                nlpResponseModel.setStatus(CommonConstants.pass);
            } else {
                log.info("Entered coordinate value is wrong");
                log.error("Failed to swipe from right to left\n");
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("	 System.out.println(\"Swiped from right to left\");\n");
        sb.append("} else {\n");
        sb.append("	 System.out.println(\"Entered coordinate value is wrong\");\n");
        sb.append("	 System.out.println(\"Failed to swipe from right to left\");\n");
        sb.append("}\n");
