...
@Slf4j
@Component(value = "MOB_PressEnterKey")
public class PressEnterKey implements Nlp {
    @Override
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.error("NLP_EXCEPTION in PressEnterKey ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("androidDriver.pressKey(new KeyEvent().withKey(AndroidKey.ENTER));\n");
