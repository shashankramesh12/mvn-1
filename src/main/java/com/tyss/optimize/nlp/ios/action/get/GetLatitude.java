...
@Slf4j
@Component(value = "IOS_GetLatitude")
public class GetLatitude implements Nlp {
    @Override
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Getting Geo location latitude");
            deviceLocation = (Double) ((Location) ((NlpResponseModel) new GetDeviceLocation().execute(requestDevice)).getAttributes().get("location")).getLatitude();
            log.info("Successfully fetched Geo location latitude");
            ...
            log.error("NLP_EXCEPTION in GetLatitude ", e);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("Double deviceLocation = iosDriver.location().getLatitude();\n");
