...
public class SwipeDown implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            if (fromY < toY) {
                ...
                log.info("Swiped screen from top to bottom");
                nlpResponseModel.setMessage(passMessage);
                nlpResponseModel.setStatus(CommonConstants.pass);
            } else {
                log.error("Entered coordinate value is wrong");
                log.error("Failed to swipe screen from top to bottom");
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("	System.out.println(\"Swiped screen from top to bottom\");\n");
        sb.append("} else {\n");
        sb.append("	System.out.println(\"Entered coordinate value is wrong\");\n");
        sb.append("	System.out.println(\"Failed to swipe screen from top to bottom\");\n");
        sb.append("}\n");
