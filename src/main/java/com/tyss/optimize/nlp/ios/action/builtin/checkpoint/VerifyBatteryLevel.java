...
import com.tyss.optimize.nlp.ios.action.get.GetBatteryPercentage;
...
@Slf4j
@Component(value = "IOS_VerifyBatteryLevel")
public class VerifyBatteryLevel implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            modifiedFailMessage = failMessage.replace("*expectedBatteryPercentage*", String.valueOf(expectedBatteryPercentage));
            String modifiedPassMessage = passMessage.replace("*expectedBatteryPercentage*", String.valueOf(expectedBatteryPercentage));
            ...
            if (batteryPercentage > expectedBatteryPercentage) {
                ...
                log.error("Device battery percentage is less than " + expectedBatteryPercentage);
