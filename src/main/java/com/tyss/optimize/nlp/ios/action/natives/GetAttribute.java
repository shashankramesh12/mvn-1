...
@Slf4j
@Component(value = "IOS_GetAttribute")
public class GetAttribute implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Getting attribute " + attributeName
            ...
            log.info("Successfully fetched attribute " + attributeName
            ...
            log.error("NLP_EXCEPTION in GetAttribute ", e);
