package com.tyss.optimize.nlp.ios.webelement;
...
@Slf4j
@Component(value = "IOS_GetScreenshot")
public class GetScreenshot implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            if(isAlertPresent(iosDriver)) {
                ...
                source = ((TakesScreenshot) iosDriver).getScreenshotAs(OutputType.FILE);
            }
    ...
    public boolean isAlertPresent(IOSDriver driver) {
        try {
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("try{\n");
        sb.append("  iosDriver.switchTo().alert();\n");
        sb.append("  flag = true;\n");
        ...
        sb.append("} else {\n");
        sb.append("  source = ((TakesScreenshot) iosDriver).getScreenshotAs(OutputType.FILE);\n");
        sb.append("}\n");
