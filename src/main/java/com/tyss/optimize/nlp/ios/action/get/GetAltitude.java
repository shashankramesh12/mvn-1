...
@Slf4j
@Component(value = "IOS_GetAltitude")
public class GetAltitude implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            deviceLocation = (Double) ((Location) ((NlpResponseModel) new GetDeviceLocation().execute(requestDevice)).getAttributes().get("location")).getAltitude();
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("Double deviceLocation = iosDriver.location().getAltitude();\n");
