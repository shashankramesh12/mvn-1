...
@Slf4j
@Component(value = "SwitchToWindowBasedOnURL")
public class SwitchToWindowBasedOnURL implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Switching to child window based on url" + url);
            ...
            for (String windowHandle : allWindowHandles) {
                ...
                if (actualUrl.equalsIgnoreCase(url)) {
                    ...
                    tabFound = true;
                    log.info("Switched to new window where url is " + url);
            ...
            log.error("NLP_EXCEPTION in SwitchToWindowBasedOnURL ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("		System.out.println(\"Switched to new window where URL is \" + url);\n");
        sb.append("		break;\n");
        sb.append("	} else {\n");
