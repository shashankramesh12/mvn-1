...
@Slf4j
@Component(value = "GetAudioDimension")
public class GetAudioDimension implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            Object height = ((JavascriptExecutor) driver).executeScript("return arguments[0].audioHeight;", element);
            Object width = ((JavascriptExecutor) driver).executeScript("return arguments[0].audioWidth;", element);
            nlpResponseModel.getAttributes().put("dimension", width+":"+height);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.setMessage(passMessage);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in GetAudioDimension ", exception);
