...
@Slf4j
@Component(value = "BrowserWindow:OpenBrowserByDisablingLocation")
public class BrowserWindowOpenBrowserByDisablingLocation implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            String task = "--disable-geolocation";
            ...
            log.info("Opening browser by disabling location");
            nlpResponseModel.setMessage(passMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.getAttributes().put("driver",webDriver);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in Opening Browser By Disabling location ", exception);
