...
@Slf4j
    @Component(value = "GetDataFromJsonPath")
public class GetDataFromJsonPath implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            String jsonPath = attributes.get("jsonPath").toString();
            passMessage = passMessage.replace("*API*",apiUrl);
            ...
            nlpResponseModel.getAttributes().put("returnValue", new JsonHelper().getJsonPathData(jsonPath, jsonObject));
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.setMessage(passMessage);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in GetDataFromJsonPath ", exception);
