...
@Slf4j
@Component(value = "BrowserWindow:ScrollUpFromCurrentPosition")
public class BrowserWindowScrollUpFromCurrentPosition implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            String scrollUp = "window.scrollBy" + "(" + xCoordinate + ", " + "-" + yCoordinate + ")";
            ...
            log.error("NLP_EXCEPTION in BrowserWindow:ScrollUpFromCurrentPosition ", exception);
