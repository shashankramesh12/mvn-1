...
@Slf4j
@Component(value = "WaitUntilElementIsInvisible")
public class WaitUntilElementIsInvisible implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            new WebDriverWait(driver, explicitTimeOut).until(ExpectedConditions.invisibilityOfElementLocated(By.name(elementName)));
            ...
            log.info("Waited for" + elementName + elementType + "to be invisible ");
            ...
            log.info(elementName + elementType + "are invisible ");
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in WaitUntilElementIsInvisible ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("wait.until(ExpectedConditions.invisibilityOfElementLocated(By.name(elementName)));\n");
