...
@Slf4j
@Component(value = "SwitchToWindowIfTitleContainsString")
public class SwitchToWindowIfTitleContainsString implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Switching to child window based on title " + title);
            ...
            for (String windowHandle : allWindowHandles) {
                ...
                if (actualTitle.contains(title)) {
                    ...
                    tabFound = true;
                    log.info("Switched to child window where title contains " + title);
            ...
            log.error("NLP_EXCEPTION in SwitchToWindowIfTitleContainsString ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("	if (actualTitle.contains(title)) {\n");
        sb.append("		tabFound = true;\n");
        sb.append("		System.out.println(\"Switched to child window where Title contains \" + title);\n");
        sb.append("		break;\n");
        sb.append("	} else {\n");
