...
@Slf4j
@Component(value = "PressEscapeKey")
public class PressEscapeKey implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.error("NLP_EXCEPTION in PressEscapeKey ", exception);
