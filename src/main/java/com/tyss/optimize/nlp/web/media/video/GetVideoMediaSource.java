...
@Slf4j
@Component(value = "GetVideoMediaSource")
public class GetVideoMediaSource implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            Object mediaSource = ((JavascriptExecutor) driver).executeScript("return arguments[0].currentSrc;", element);
            passMessage = passMessage.replace("*returnValue*", mediaSource.toString());
            nlpResponseModel.getAttributes().put("mediaSource", mediaSource.toString());
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.setMessage(passMessage);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in GetVideoMediaSource ", exception);
