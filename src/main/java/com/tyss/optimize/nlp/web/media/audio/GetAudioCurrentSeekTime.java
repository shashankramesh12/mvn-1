...
@Slf4j
@Component(value = "GetAudioCurrentSeekTime")
public class GetAudioCurrentSeekTime implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            log.error("NLP_EXCEPTION in GetAudioCurrentSeekTime ", exception);
