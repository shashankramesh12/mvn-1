...
@Slf4j
@Component(value = "GetAudioHeight")
public class GetAudioHeight implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            Double height = (Double) ((JavascriptExecutor) driver).executeScript("return arguments[0].audioHeight;", element);
            nlpResponseModel.getAttributes().put("audioHeight", height);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.setMessage(passMessage);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in GetAudioHeight ", exception);
