...
@Slf4j
@Component(value = "VerifyAllBrokenImages")
public class VerifyAllBrokenImages implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            passMessage = passMessage.replace("*page url*",driver.getCurrentUrl());
            modifiedFailMessage = modifiedFailMessage.replace("*page url*",driver.getCurrentUrl());
            ...
            log.error("NLP_EXCEPTION in VerifyAllBrokenImages ", exception);
