...
@Slf4j
@Component(value = "SwitchToFrameByFrameName")
public class SwitchToFrameByFrameName implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Switching to frame by id or name");
            modifiedPassMessage = passMessage.replace("*name*", name);
            modifiedFailMessage = failMessage.replace("*name*", name);
            driver.switchTo().frame(name);
            log.info("Switched to frame where id or name is " + name);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Throwable e) {
            log.error("NLP_EXCEPTION in SwitchToFrameByFrameName ", e);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("driver.switchTo().frame(name);\n");
