...
@Slf4j
@Component(value = "PauseVideo")
public class PauseVideo implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            if(paused){
                ...
                nlpResponseModel.getAttributes().put("videoPause", true);
            } else {
                nlpResponseModel.setStatus(CommonConstants.fail);
                nlpResponseModel.setMessage(modifiedFailMessage);
                nlpResponseModel.getAttributes().put("videoPause", false);
            }
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in PauseVideo ", exception);
