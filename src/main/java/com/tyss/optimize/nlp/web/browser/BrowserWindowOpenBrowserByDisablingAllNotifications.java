...
@Slf4j
@Component(value = "BrowserWindow:OpenBrowserByDisablingAllNotifications")
public class BrowserWindowOpenBrowserByDisablingAllNotifications implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            String task = "disable-notifications";
           WebDriver webDriver = WebDriverBrowserOptions.getBrowserOption(driverType, driverPath, task);
            ...
            log.info("Opening browser by disabling notifications");
            nlpResponseModel.setMessage(passMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.getAttributes().put("driver",webDriver);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in Opening Browser By Disabling notifications ", exception);
