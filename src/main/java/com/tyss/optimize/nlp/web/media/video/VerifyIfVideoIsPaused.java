...
@Slf4j
@Component(value = "VerifyIfVideoIsPaused")
public class VerifyIfVideoIsPaused implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            nlpResponseModel.getAttributes().put("videoPaused", paused);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in VerifyIfVideoIsPaused ", exception);
