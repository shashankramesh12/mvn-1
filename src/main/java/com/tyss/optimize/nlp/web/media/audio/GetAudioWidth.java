...
@Slf4j
@Component(value = "GetAudioWidth")
public class GetAudioWidth implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            Double width = (Double) ((JavascriptExecutor) driver).executeScript("return arguments[0].audioWidth;", element);
            nlpResponseModel.getAttributes().put("audioWidth", width);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.setMessage(passMessage);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in GetAudioWidth ", exception);
