...
@Slf4j
@Component(value = "WaitTillTitleOfPageIsString")
public class WaitTillTitleOfPageIsString implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Waiting till title of page is " + title);
            ...
            log.info("Waited till title of page is " + title);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in WaitTillTitleOfPageIsString ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("wait.until(ExpectedConditions.titleIs(Title));\n");
