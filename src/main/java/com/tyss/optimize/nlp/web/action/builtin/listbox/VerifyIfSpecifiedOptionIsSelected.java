...
public class VerifyIfSpecifiedOptionIsSelected implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Verifying ListBox if option with text " + expectedValue + " is selected in " + elementName + " " + elementType);
            ...
            if (match) {
                log.info("Option" + expectedValue + " with text " + expectedValue + " is selected in " + elementName + " " + elementType);
                nlpResponseModel.setMessage(modifiedPassMessage);
                nlpResponseModel.setStatus(CommonConstants.pass);
            } else {
                log.error("Option" + expectedValue + " with text " + expectedValue + " is not selected in " + elementName + " " + elementType);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("}\n");
        sb.append("if (match) {\n");
        sb.append("	System.out.println(\"Option \" + expectedValue + \" with text \" + expectedValue + \" is selected\");\n");
        sb.append("} else {\n");
        sb.append("	System.out.println(\"Option \" + expectedValue + \" with text \" + expectedValue + \" is not selected\");\n");
        sb.append("}\n");
