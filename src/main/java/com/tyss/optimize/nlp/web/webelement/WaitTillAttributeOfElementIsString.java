...
@Slf4j
@Component(value = "WaitTillAttributeOfElementIsString")
public class WaitTillAttributeOfElementIsString implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Waiting till " + attribute + " attribute of " + elementName + " " + elementType + " is " + value);
            WebDriverWait wait = new WebDriverWait(driver, time);
            wait.until(ExpectedConditions.attributeToBe(element, attribute, value));
            log.info("Successfully waited " + attribute + " attribute of " + elementName + " " + elementType + " is " + value);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in WaitTillAttributeOfElementIsString ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("wait.until(ExpectedConditions.attributeToBe(element, attribute, value));\n");
