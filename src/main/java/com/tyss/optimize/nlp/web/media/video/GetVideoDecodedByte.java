...
@Slf4j
@Component(value = "GetVideoDecodedByte")
public class GetVideoDecodedByte implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            Long decodedByte = (Long) ((JavascriptExecutor) driver).executeScript("return arguments[0].webkitVideoDecodedByteCount;", element);
            ...
            log.error("NLP_EXCEPTION in GetVideoDecodedByte ", exception);
