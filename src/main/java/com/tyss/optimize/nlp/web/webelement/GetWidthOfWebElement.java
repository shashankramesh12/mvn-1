...
@Slf4j
@Component(value = "GetWidthOfWebElement")
public class GetWidthOfWebElement implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Fetching the width of " + elementName + " " + elementType);
            width = element.getSize().getWidth();
            log.info("Successfully fetched width of " + elementName + " " + elementType);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.getAttributes().put("width", width);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in GetWidthOfWebelement ", exception);
