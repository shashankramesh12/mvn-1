...
@Slf4j
@Component(value = "PressAndHoldLeftMouseButton")
public class PressAndHoldLeftMouseButton implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.error("NLP_EXCEPTION in PressAndHoldLeftMouseButton ", e);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("actions.clickAndHold(element).build().perform();\n");
