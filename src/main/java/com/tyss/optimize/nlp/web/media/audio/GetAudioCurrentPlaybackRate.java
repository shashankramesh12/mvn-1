...
@Slf4j
@Component(value = "GetAudioCurrentPlaybackRate")
public class GetAudioCurrentPlaybackRate implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            log.error("NLP_EXCEPTION in GetAudioCurrentPlaybackRate ", exception);
