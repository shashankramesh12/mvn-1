...
@Slf4j
@Component(value = "CreateSheet")
public class CreateSheet implements Nlp {
    @Override
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        String sheetName = null, filePath = null;
        try {
            Map<String, Object> attributes = nlpRequestModel.getAttributes();
            filePath = (String) attributes.get("filePath");
            ...
            log.info("Successfully created new sheet " + sheetName + " in workbook file path " + filePath);
            nlpResponseModel.setMessage(passMessage.replace("*sheetName*", sheetName).replace("*filePath*", filePath));
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in CreateSheet ", exception);
            failMessage = failMessage.replace("*sheetName*", sheetName).replace("*filePath*", filePath);
