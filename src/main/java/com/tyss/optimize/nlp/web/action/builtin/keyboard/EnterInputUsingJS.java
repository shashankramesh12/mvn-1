...
@Slf4j
@Component(value = "EnterInputUsingJS")
public class EnterInputUsingJS implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Enter input " + input + " into element " + elementName + " " + elementType + " by JavascriptExecutor");
            ((JavascriptExecutor) driver).executeScript("arguments[0].value='" + input + "'", element);
            log.info("Entered input " + input + " into element " + elementName + " " + elementType);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in EnterInputUsingJS ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("((JavascriptExecutor) driver).executeScript(\"arguments[0].value='\" + INPUT + \"'\", element);\n");
