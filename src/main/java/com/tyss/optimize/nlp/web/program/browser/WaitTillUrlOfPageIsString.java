...
@Slf4j
@Component(value = "WaitTillUrlOfPageIsString")
public class WaitTillUrlOfPageIsString implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Waiting till url of page is " + url);
            ...
            log.info("Waited till url of page is " + url);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in WaitTillUrlOfPageIsString ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("wait.until(ExpectedConditions.urlToBe(URL));\n");
