...
@Slf4j
@Component(value = "MuteVideo")
public class MuteVideo implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            nlpResponseModel.getAttributes().put("videoMuted", muted);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in MuteVideo ", exception);
