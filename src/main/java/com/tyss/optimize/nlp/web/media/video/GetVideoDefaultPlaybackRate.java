...
@Slf4j
@Component(value = "GetVideoDefaultPlaybackRate")
public class GetVideoDefaultPlaybackRate implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            nlpResponseModel.getAttributes().put("returnValue", (double)playbackRate);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.setMessage(passMessage);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in GetVideoDefaultPlaybackRate ", exception);
