...
@Slf4j
@Component(value =  "SwitchToDefaultContent")
public class SwitchToDefaultContent implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		log.info("Switching to main page from current frame");
			...
			nlpResponseModel.setStatus(CommonConstants.pass);
         	...
         	log.error("NLP_EXCEPTION in SwitchToDefaultContent", e);
