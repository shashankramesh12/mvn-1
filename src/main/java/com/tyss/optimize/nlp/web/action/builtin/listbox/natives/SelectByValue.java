...
@Slf4j
@Component(value = "SelectByValue")
public class SelectByValue implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Selecting the options by value:" + value + " in the " + elementName + " " + elementType);
            ...
            log.info("Selected option from " + elementName + " " + elementType + " whose value is " + value);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Throwable e) {
            log.error("NLP_EXCEPTION in SelectByValue ", e);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("select.selectByValue(value);\n");
