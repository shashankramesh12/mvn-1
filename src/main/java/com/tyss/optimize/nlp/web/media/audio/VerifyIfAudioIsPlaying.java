...
@Slf4j
@Component(value = "VerifyIfAudioIsPlaying")
public class VerifyIfAudioIsPlaying implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            if(paused){
                ...
                nlpResponseModel.getAttributes().put("audioPlay", false);
            } else {
                nlpResponseModel.setMessage(passMessage);
                nlpResponseModel.setStatus(CommonConstants.pass);
                nlpResponseModel.getAttributes().put("audioPlay", true);
            }
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in VerifyIfAudioIsPlaying ", exception);
