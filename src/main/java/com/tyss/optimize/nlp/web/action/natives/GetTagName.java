...
public class GetTagName implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Getting  tagName of " + elementName + " " + elementType);
            ...
            String modifiedPassMessage = passMessage.replace("*elementName*", elementName)
                    .replace("*elementType*", elementType).replace("*returnValue*", tagName);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
            containsChildNlp = (Boolean) attributes.get("containsChildNlp");
            nlpResponseModel.getAttributes().put("tagName", tagName);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in GetTagName ", exception);
