...
@Slf4j
@Component(value = "GetVideoCurrentPlaybackRate")
public class GetVideoCurrentPlaybackRate implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            Long playbackRate = (Long) ((JavascriptExecutor) driver).executeScript("return arguments[0].playbackRate;", element);
            passMessage.replace("*returnValue*", playbackRate.toString());
            nlpResponseModel.getAttributes().put("playbackrate",(double)playbackRate);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.setMessage(passMessage);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in GetVideoCurrentPlaybackRate ", exception);
