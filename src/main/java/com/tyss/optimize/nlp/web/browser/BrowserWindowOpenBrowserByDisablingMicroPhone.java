...
@Slf4j
@Component(value = "BrowserWindow:OpenBrowserByDisablingMicroPhone")
public class BrowserWindowOpenBrowserByDisablingMicroPhone implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            String task = "disable-microphone";
            ...
            log.info("Opening browser by disabling microphone");
            nlpResponseModel.setMessage(passMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.getAttributes().put("driver",webDriver);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in Opening Browser By Disabling microphone ", exception);
