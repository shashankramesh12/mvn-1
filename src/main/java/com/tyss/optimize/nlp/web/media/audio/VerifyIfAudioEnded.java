...
@Slf4j
@Component(value = "VerifyIfAudioEnded")
public class VerifyIfAudioEnded implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            Boolean ended =  (Boolean) ((JavascriptExecutor) driver).executeScript("return arguments[0].ended;", element);
            if(Objects.nonNull(ended) && ended){
            ...
            nlpResponseModel.getAttributes().put("ended", ended);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in VerifyIfAudioEnded ", exception);
