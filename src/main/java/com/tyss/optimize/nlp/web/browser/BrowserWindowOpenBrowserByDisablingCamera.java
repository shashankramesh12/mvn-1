...
@Slf4j
@Component(value = "BrowserWindow:OpenBrowserByDisablingCamera")
public class BrowserWindowOpenBrowserByDisablingCamera implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Opening browser by disabling camera");
            nlpResponseModel.setMessage(passMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.getAttributes().put("driver",webDriver);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in Opening Browser By Disabling Camera ", exception);
