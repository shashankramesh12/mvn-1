...
@Slf4j
@Component(value = "VerifyCheckBoxIsNotSelected")
public class VerifyCheckBoxIsNotSelected implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {
            ...
            log.info("Verifying if " + elementName + " " + elementType + " is not selected");
            ...
            if (!(tag.equalsIgnoreCase("input") && (type.equalsIgnoreCase("checkbox")))) {
                log.error("InvalidElementTypeException: Element should be checkbox to verify the 'Selected' status");
                ...
                if (actualSelectedStatus) {
                    log.error(elementName + " " + elementType + " " + "is selected");
                    nlpResponseModel.setMessage(modifiedFailMessage);
                    nlpResponseModel.setStatus(CommonConstants.fail);
                    nlpResponseModel.setIfCheckPointIsFailed(ifCheckPointIsFailed);
                } else {
                    log.info(elementName + " " + elementType + " " + "is not selected");
            ...
            log.error("NLP_EXCEPTION in VerifyCheckBoxIsNotSelected ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("if (!(tag.equalsIgnoreCase(\"input\") && (type.equalsIgnoreCase(\"checkbox\")))) {\n");
        sb.append("	System.out.println(\"InvalidElementTypeException: Element should be checkbox to verify the \'Selected\' status\");\n");
        sb.append("} else {\n");
