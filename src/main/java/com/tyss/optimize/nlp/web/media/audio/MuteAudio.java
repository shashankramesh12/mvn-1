...
@Slf4j
@Component(value = "MuteAudio")
public class MuteAudio implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            ((JavascriptExecutor) driver).executeScript("arguments[0].muted=true;", element);
            ...
            nlpResponseModel.getAttributes().put("audioMuted", muted);
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in MuteAudio ", exception);
