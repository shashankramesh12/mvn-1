...
@Slf4j
@Component(value = "SelectByVisibleText")
public class SelectByVisibleText implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Selecting the options by text:" + text + " in the " + elementName + " " + elementType);
            ...
            log.info("Selected option from " + elementName + " " + elementType + " whose text is " + text);
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Throwable e) {
            log.error("NLP_EXCEPTION in SelectByVisibleText ", e);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("select.selectByVisibleText(text);\n");
