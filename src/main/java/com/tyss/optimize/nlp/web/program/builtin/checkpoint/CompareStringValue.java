...
@Slf4j
@Component(value = "CompareStringValue")
public class CompareStringValue implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Verifying if actual value " + actualString + " matches expected value " + expectedString);
            Boolean match = false;
            log.info("Exepected Value:" + expectedString);
            ...
            if (match) {
                ...
                log.error(actualString + " did not match with " + expectedString);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("} else {\n");
        sb.append("	System.out.println(actualString + \" did not match with \" + expectedString);\n");
        sb.append("}\n");
