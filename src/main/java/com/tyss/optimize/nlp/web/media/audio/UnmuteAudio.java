...
@Slf4j
@Component(value = "UnmuteAudio")
public class UnmuteAudio implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            if(muted){
                ...
                nlpResponseModel.getAttributes().put("audioMuted", false);
            } else {
                nlpResponseModel.setMessage(passMessage);
                nlpResponseModel.setStatus(CommonConstants.pass);
                nlpResponseModel.getAttributes().put("audioMuted", true);
            }
        } catch (Exception exception){
            log.error("NLP_EXCEPTION in UnmuteAudio ", exception);
