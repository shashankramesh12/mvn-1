...
@Slf4j
@Component(value = "VideoSeekBackward")
public class VideoSeekBackward implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try{
            ...
            Double time = (Double) attributes.get("seconds");
            ...
            log.error("NLP_EXCEPTION in VideoSeekBackward ", exception);
