...
@Slf4j
@Component(value = "BrowserWindow:OpenBrowserByEnablingMicroPhone")
public class BrowserWindowOpenBrowserByEnablingMicroPhone implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.info("Opening browser by enabling microphone");
            nlpResponseModel.setMessage(passMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
            nlpResponseModel.getAttributes().put("driver",webDriver);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in Opening Browser By Enabling microphone ", exception);
