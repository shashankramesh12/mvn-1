...
@Slf4j
@Component(value = "GetAllValues")
public class GetAllValues implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.error("NLP_EXCEPTION in GetAllValues ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append(" 	values[i] = prop.getProperty(key);\n");
        sb.append(" 	i++;\n");
        sb.append(" }\n");
