...
@Slf4j
@Component(value = "SortListOfStringInAscendingOrder")
public class SortListOfStringInAscendingOrder implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.error("NLP_EXCEPTION in SortListOfStringInAscendingOrder ", exception);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("List<String> sortedList = list.stream().sorted().collect(Collectors.toList());\n");
