...
@Slf4j
@Component(value = "PressControlKey")
public class PressControlKey implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            log.error("NLP_EXCEPTION in PressControlKey ", exception);
