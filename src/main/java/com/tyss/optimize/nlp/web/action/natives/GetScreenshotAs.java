...
@Slf4j
@Component(value = "GetScreenshotAs")
public class GetScreenshotAs implements Nlp {
    ...
    public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
        ...
        try {
            ...
            String modifiedPassMessage = passMessage.replace("*elementName*", elementName)
                    .replace("*elementType*", elementType).replace("*returnValue", String.valueOf(file));
            nlpResponseModel.setMessage(modifiedPassMessage);
            nlpResponseModel.setStatus(CommonConstants.pass);
        } catch (Exception exception) {
            log.error("NLP_EXCEPTION in GetScreenshotAs ", exception);
        ...
        nlpResponseModel.getAttributes().put("file", file);
    ...
    public StringBuilder getTestCode() throws NlpException {
        ...
        sb.append("File file = element.getScreenshotAs(OutputType.FILE);\n");
